...
flags = tf.app.flags
flags.DEFINE_string("save_path", './saved_model', "Directory to write the model and "
                    "training summaries.")
flags.DEFINE_string("train_data", '/storage/text8/text8', "Training text file. "
                    "E.g., unzipped file http://mattmahoney.net/dc/text8.zip.")
flags.DEFINE_string(
    "eval_data", 'val.txt', "File consisting of analogies of four tokens."
...
def main(_):
  ...
  with graph.as_default():
    with graph.device(device_for_node),  tf.Session() as session:
